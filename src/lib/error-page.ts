...
<html lang="en">
  <head>
    ...
    <style>
      body { font: 15px/1.5 system-ui, -apple-system, sans-serif; background: #fff5f8; color: #4f1239; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; }
