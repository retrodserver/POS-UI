  ...
  const runs = [
    {
      id: "EXEC-881",
      date: "02 Sep 2026",
      item: "Makhani Gravy Base",
      batchQty: "25 L",
      rawMaterialsDeducted: "Tomatoes (15kg), Butter (3kg), Cream (2L)",
      status: "Completed",
    ...
    },
    {
      ...
      batchQty: "40 pcs",
      rawMaterialsDeducted: "Flour (10kg), Yeast (100g), Olive Oil",
      status: "In Progress",
      operator: "Sunita M.",
    },
    {
      id: "EXEC-879",
      date: "01 Sep 2026",
      item: "Tandoori Chicken Marination",
      batchQty: "15 kg",
      rawMaterialsDeducted: "Chicken Breast (15kg), Spices",
      status: "Completed",
      operator: "Chef Vikram",
    },
  ];
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h2 className="text-[18px] font-bold text-slate-900 tracking-tight">Prepare Items</h2>
          <p className="text-[12.5px] text-slate-500 mt-0.5">
            Log and track daily food preparation batches. Converting raw materials automatically
            deducts component stocks and adds finished goods.
          </p>
        </div>

        <button
          type="button"
          onClick={() => toast.success("Opening New Preparation Batch modal...")}
